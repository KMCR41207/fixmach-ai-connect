...
function Landing() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* AI diagnosis */}
      <section id="ai-diagnosis" className="mx-auto scroll-mt-24 w-[min(1200px,92%)] py-24">
      ...
      {/* How it works */}
      <section id="how-it-works" className="scroll-mt-24 border-y border-border bg-secondary/40 py-24">
      ...
      {/* Machine categories */}
      <section id="machines" className="mx-auto scroll-mt-24 w-[min(1200px,92%)] py-24">
        <div className="max-w-2xl">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">
            Machine coverage
          </p>
      ...
      {/* Industries */}
      <section id="industries" className="scroll-mt-24 border-y border-border bg-secondary/40 py-24">
        <div className="mx-auto w-[min(1200px,92%)]">
          <div className="max-w-2xl">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">
              Industries served
      ...
      {/* Technicians */}
      <section id="technicians" className="scroll-mt-24 border-t border-border bg-steel py-24 text-steel-foreground">
      ...
      <section id="testimonials" className="mx-auto scroll-mt-24 w-[min(1200px,92%)] py-24">
        <div className="max-w-2xl">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-primary">
            Proof on the floor
          </p>
      ...
      {/* FAQ */}
      <section id="faq" className="mx-auto scroll-mt-24 w-[min(1200px,92%)] py-24">
        <div className="max-w-2xl">
      ...
      {/* CTA */}
      <section id="book" className="mx-auto scroll-mt-24 w-[min(1200px,92%)] pb-24">
